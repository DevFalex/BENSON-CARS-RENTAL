...
$qry = $wpdb->get_results("SELECT option_value from $option where option_name = 'sync_restau_page_thank_u';");
		...
		<div class="modal-content">
			<div class="modal-bodyy">
				<div class="trans_info">
					<p class="reserve_sucess"> Table Reservation Successful </p>
					<i class="fa fa-exclamation"></i>
					<p class="details_qr"> Download your QR Code and show it to a restaurant personnel. </p>
						        ...
						        jQuery(function($) {
								    ...
								    paypal.Buttons({
									    ...
									    createOrder: function(data, actions) {
											...
											var qty          = item_qty;
											var amount       = temporary_entry[5];
 
											// var amount      = temporary_entry[3]; 
											var description = item+' | Price: '+amount+' | Qty(s): '+ qty; 
											var total       = temporary_entry[3];
											var currency    = '<?php echo $sync_default_rate; ?>';
											console.log(item+' '+amount+' '+currency+' '+description);
											$('#restau_pay_now').trigger('click');
